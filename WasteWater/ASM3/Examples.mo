...
package Examples "Demonstration examples of the components of the ASM3 library"
  ...
  class SmallPlant "Small WWTP Configuration"
    ...
    SecClar.Krebs.SecClarModKrebs Settler annotation (Placement(transformation(
            extent={{50,-2},{70,18}})));
  equation
    connect(tank3.Out, divider.In) annotation (Line(points={{14,4},{16,4},{16,
            4.3},{19.9,4.3}}));
    connect(tank2.Out, tank3.In) annotation (Line(points={{-12,4},{-6,4}}));
    connect(mixer.Out, tank1.In) annotation (Line(points={{-84,31.7},{-79,31.7},
            {-79,4},{-68,4}}));
    ...
    connect(WastePump.Out, WasteSludge.In) annotation (Line(points={{90,-26.9},
    ...
    connect(Temperature.y, tank1.T) annotation (Line(points={{-81.4,56},{-74,56},
            {-74,8},{-71,8},{-71,8},{-68,8}}, color={0,0,255}));
    connect(Temperature.y, tank2.T) annotation (Line(points={{-81.4,56},{-74,56},
            {-74,14},{-32,14},{-32,8}}, color={0,0,255}));
    connect(Temperature.y, tank3.T) annotation (Line(points={{-81.4,56},{-74,56},
            {-74,14},{-5.9,14},{-5.9,8},{-6,8}},   color={0,0,255}));
    ...
    connect(RecyclePump.u, Constant1.y) annotation (Line(points={{-75.2,-14.5},
            {-46,-14.5},{-46,-76},{-63,-76}},
                                           color={0,0,255}));
    ...
    connect(sensor_NO1.In, Settler.Effluent) annotation (Line(points={{100,16},
            {100,13.7},{70.2,13.7}}));
    connect(Settler.Feed, divider.Out1) annotation (Line(points={{50,9.4},{48,
            9.4},{48,10},{45.9,10},{45.9,7},{39.9,7}}));
...
"));
  ...
  equation
    ...
    connect(cdivider2.Out1, mixer2_2.In1) annotation (Line(points={{-22,80},{40,
            80},{40,30},{49.9,30}}));
    connect(cdivider3.Out2, mixer2_5.In1) annotation (Line(points={{-132,-85.2},
            {-172,-85.2},{-172,-2},{-140.1,-2}}));
    connect(Constant7.y, cdivider2.u) annotation (Line(points={{-55.5,103},{
            -50.5,103},{-50.5,54},{-32,54},{-32,71}}, color={0,0,255}));
    connect(cdivider3.In, ReturnPump.Out) annotation (Line(points={{-111.9,
            -87.4},{-86.1,-87.4},{-86.1,-96.9},{-54,-96.9}}));
    connect(cdivider3.Out1, mixer2_3.In2) annotation (Line(points={{-132,-90},{
            -184,-90},{-184,26},{-168.1,26}}));
    connect(cdivider1.Out2, mixer2_3.In1) annotation (Line(points={{-148,73.2},
            {-143,73.2},{-143,40},{-184,40},{-184,31},{-168.1,31}}));
    connect(WastePump.Out, WasteSludge.In) annotation (Line(points={{148,-91.1},
            {159,-91.1},{159,-91.2},{170,-91.2}}));
    connect(ControlledDivider2_1.Out2, mixer2_1.In2) annotation (Line(points={{-51,
            -37.2},{-51,-38.5},{-51,24},{-45.1,24}}));
    connect(ControlledDivider2_1.Out1, mixer2_5.In2) annotation (Line(points={{-51,-42},
            {-150,-42},{-150,-7},{-140.1,-7}}));
    ...
    connect(sensor_O2_3.In, nitri2.MeasurePort) annotation (Line(points={{125,40},
            {125,32.5},{125.5,32.5}}));
    connect(sensor_Q1.Out, cdivider1.In) annotation (Line(points={{-173.8,76},{
            -171,76},{-171,75.4},{-168.1,75.4}}));
    connect(cdivider2.Out2, mixer3_1.In1) annotation (Line(points={{-22,75.2},{
            -18,75.2},{-18,47},{-111,47},{-111,27.9},{-107,27.9}}));
    connect(mixer3_1.Out, deni1.In) annotation (Line(points={{-87,23.7},{-83,
            23.7},{-83,24},{-80,24}}));
    ...
    connect(Feedback2.u1, TwoPoint2.u)
      annotation (Line(points={{128,104},{124.5,104},{124.5,105},{120.5,105}},
                                                     color={0,0,255}));
    ...
    connect(Gain1.y, blower3.u) annotation (Line(points={{50,105},{55,105},{55,
            83},{49,83},{49,-16},{32.9,-16}},
                                            color={0,0,255}));
    connect(Gain3.y, blower2.u) annotation (Line(points={{108.7,-21},{139,-21},
            {139,-6},{130.9,-6}}, color={0,0,255}));
    connect(blower1.u, Gain2.y)
      annotation (Line(points={{164.9,-6},{195,-6},{195,103},{165,103}}, color=
            {0,0,255}));
    connect(Settler.Feed, divider2_1.Out1) annotation (Line(points={{68,-72.6},
            {38.1,-72.6},{38.1,-38},{47.1,-38}}));
    connect(RecyclePump.Out, ControlledDivider2_1.In) annotation (Line(points={{0,-38.9},
            {-8,-38.9},{-8,-39},{-15.9,-39},{-15.9,-39.4},{-30.9,-39.4}}));
    connect(RecyclePump.In, divider2_1.Out2) annotation (Line(points={{20,-32.7},
            {27,-32.7},{27,-33},{34,-33},{34,-33.2},{47,-33.2}}));
    connect(ReturnController1.out, ReturnPump.u) annotation (Line(points={{-13.3,
            -108},{-8,-108},{-8,-96.5},{-35.2,-96.5}},
                                                 color={0,0,255}));
    ...
    connect(blower1.AirOut, nitri3.AirIn) annotation (Line(points={{154,7},{154,
            18.2}}));
    connect(nitri2.AirIn, blower2.AirOut) annotation (Line(points={{120,18.2},{
            120,7}}));
    connect(CombiTableTime2.y, Preclaryfier.MeasurePort)
      annotation (Line(points={{-125.2,105},{-122.2,105},{-122.2,87}},
                                                                 color={0,0,255}));
    connect(cdivider2.In, Preclaryfier.Out) annotation (Line(points={{-42.1,
            77.4},{-79,77.4},{-79,78},{-116,78}}));
    connect(mixer2_1.In1, deni1.Out) annotation (Line(points={{-45.1,29},{-59,
            29},{-59,24},{-60,24}}));
    connect(mixer3_1.In2, anaerob.Out) annotation (Line(points={{-107.1,23.6},{
            -113,23.6},{-113,23},{-118,23}}));
...
"));
  model BSM1
    EffluentSink      Effluent annotation (Placement(transformation(extent={{106,62},
              {126,82}})));
    SludgeSink      WasteSludge annotation (Placement(transformation(extent={{104,22},
              {124,42}})));
    nitri      tank3(K_A_NH=0.4, V=1333) annotation (Placement(transformation(
            extent={{-8,76},{12,96}})));
    nitri      tank2(K_A_NH=0.4, V=1333) annotation (Placement(transformation(
            extent={{-64,76},{-44,96}})));
    deni      tank1(K_A_NH=0.4, V=3000) annotation (Placement(transformation(
            extent={{-114,76},{-94,96}})));
    mixer3      mixer annotation (Placement(transformation(extent={{-146,104},{
              -126,124}})));
    blower      blower1(Q_max=34574.2654508612) annotation (Placement(
          transformation(extent={{-64,20},{-44,40}})));
    blower      blower2(Q_max=34574.2654508612) annotation (Placement(
          transformation(extent={{-8,20},{12,40}})));
    Modelica.Blocks.Math.Feedback Feedback annotation (Placement(transformation(
            extent={{68,120},{88,140}})));
    Modelica.Blocks.Continuous.PI PI1(T=0.001, k=500)
      annotation (Placement(transformation(extent={{94,120},{114,140}})));
    Modelica.Blocks.Sources.Constant Constant1 annotation (Placement(
          transformation(extent={{-116,-4},{-96,16}})));
    pump      RecyclePump(Q_max=46115) annotation (Placement(transformation(
          origin={-96,70},
          extent={{-10,-10},{10,10}},
          rotation=180)));
    Modelica.Blocks.Sources.Step OxygenSetPoint(height=1.5)
      annotation (Placement(transformation(extent={{46,120},{66,140}})));
    pump      ReturnPump(Q_max=9223) annotation (Placement(transformation(
          origin={44,60},
          extent={{-10,-10},{10,10}},
          rotation=180)));
    pump      WastePump(Q_max=193) annotation (Placement(transformation(extent={{88,66},
              {108,46}})));
    Modelica.Blocks.Sources.Constant Constant2 annotation (Placement(
          transformation(extent={{40,24},{60,44}})));
    Modelica.Blocks.Sources.Constant Temperature(k=15)
      annotation (Placement(transformation(extent={{-144,134},{-132,146}})));
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
      fileName=Modelica.Utilities.Files.loadResource("modelica://WasteWater/Resources/ASM3/Inf_dry.txt"),
      table=[0,0; 1,1],
      columns=integer(({16,10,3,4,12,10,11,15,5,6,7,10,8})),
      tableName="Inf_dry",
      tableOnFile=("Inf_dry") <> "NoName") annotation (Placement(transformation(
            extent={{-166,160},{-146,180}})));
    sensor_NH sensor_NH1 annotation (Placement(transformation(extent={{92,96},{
              108,112}})));
    sensor_NO sensor_NO1 annotation (Placement(transformation(extent={{110,96},
              {126,112}})));
    sensor_COD sensor_COD1 annotation (Placement(transformation(extent={{74,96},
              {90,112}})));
    WWSource wWSource
      annotation (Placement(transformation(extent={{-134,160},{-114,180}})));
    sensor_O2 sensor_O2_1
      annotation (Placement(transformation(extent={{16,96},{36,116}})));
    deni      tank4(K_A_NH=0.4, V=3000) annotation (Placement(transformation(
            extent={{-90,76},{-70,96}})));
    nitri      tank5(K_A_NH=0.4, V=1333) annotation (Placement(transformation(
            extent={{-36,76},{-16,96}})));
    blower      blower3(Q_max=34574.2654508612) annotation (Placement(
          transformation(extent={{-36,20},{-16,40}})));
    JenaSecClarModTakacs jenaSecClarModTakacs
      annotation (Placement(transformation(extent={{64,72},{84,92}})));
    sensor_NO sensor_NO2
      annotation (Placement(transformation(extent={{-84,102},{-64,122}})));
    divider2 divider2_1
      annotation (Placement(transformation(extent={{36,70},{56,90}})));
    Misc.RecycleController2            RecycleController1(NO3min=1.5)
      annotation (Placement(transformation(extent={{-21,103},{-7,117}})));
    Modelica.Blocks.Nonlinear.FixedDelay FixedDelay1(delayTime=1/24/6)
      annotation (Placement(transformation(extent={{-52,103},{-38,117}})));
    sensor_COD sensor_COD2 annotation (Placement(transformation(extent={{-90,176},
              {-74,192}})));
    sensor_NH sensor_NH2 annotation (Placement(transformation(extent={{-68,176},
              {-52,192}})));
    sensor_NO sensor_NO3 annotation (Placement(transformation(extent={{-46,176},
              {-30,192}})));
  equation
    connect(Feedback.y,PI1. u) annotation (Line(points={{87,130},{92,130}}));
    connect(PI1.y,blower2. u)
      annotation (Line(points={{115,130},{128,130},{128,6},{22,6},{22,28},{18,
            28},{18,27},{11.9,27}}));
    connect(RecyclePump.Out,mixer. In3) annotation (Line(points={{-106,67.1},{
            -152,67.1},{-152,108.6},{-145.9,108.6},{-145.9,109.1}}));
    connect(OxygenSetPoint.y,Feedback. u1) annotation (Line(points={{67,130},{
            70,130}}));
    connect(ReturnPump.Out,mixer. In2) annotation (Line(points={{34,57.1},{-16,
            57.1},{-16,58},{-66,58},{-66,44},{-170,44},{-170,113.6},{-146.1,
            113.6}}));
    connect(WastePump.Out,WasteSludge. In) annotation (Line(points={{108,53.1},
            {118,53.1},{118,46},{98,46},{98,30.8},{104,30.8}}));
    connect(Constant2.y,ReturnPump. u)
      annotation (Line(points={{61,34},{64,34},{64,57.5},{52.8,57.5}}));
    connect(Constant2.y,WastePump. u)
      annotation (Line(points={{61,34},{78,34},{78,53.5},{89.2,53.5}}));
    connect(Temperature.y,tank2. T) annotation (Line(points={{-131.4,140},{-116,
            140},{-116,96},{-64,96},{-64,90}},
                                        color={0,0,255}));
    connect(wWSource.data, CombiTableTime.y) annotation (Line(
        points={{-133,170},{-145,170}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(wWSource.Out, mixer.In1) annotation (Line(
        points={{-114.2,163},{-110,163},{-110,162},{-104,162},{-104,150},{-152,
            150},{-152,117.9},{-146,117.9}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_O2_1.In, tank3.MeasurePort) annotation (Line(
        points={{26,96},{26,90.5},{7.5,90.5}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_O2_1.So, Feedback.u2) annotation (Line(
        points={{35.8,106},{72,106},{72,122},{78,122}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank1.Out, tank4.In)
      annotation (Line(points={{-94,86},{-90,86}}, smooth=Smooth.None));
    connect(tank4.Out, tank2.In) annotation (Line(
        points={{-70,86},{-64,86}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank4.T, tank2.T) annotation (Line(
        points={{-90,90},{-90,96},{-64,96},{-64,90}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank5.In, tank2.Out) annotation (Line(
        points={{-36,86},{-44,86}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(tank5.Out, tank3.In) annotation (Line(
        points={{-16,86},{-8,86}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(jenaSecClarModTakacs.Effluent, Effluent.In) annotation (Line(
        points={{84.2,87.7},{96.1,87.7},{96.1,74},{106,74}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_COD1.In, Effluent.In) annotation (Line(
        points={{82,96},{82,94},{96,94},{96,92},{96.1,92},{96.1,74},{106,74}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_NH1.In, Effluent.In) annotation (Line(
        points={{100,96},{100,86},{96,86},{96,74},{106,74}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_NO1.In, Effluent.In) annotation (Line(
        points={{118,96},{110,96},{110,82},{98,82},{98,74},{106,74}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(jenaSecClarModTakacs.Return, ReturnPump.In) annotation (Line(
        points={{71,72.4},{62.5,72.4},{62.5,63.3},{54,63.3}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(jenaSecClarModTakacs.Waste, WastePump.In) annotation (Line(
        points={{77,72.4},{77,65.2},{88,65.2},{88,59.3}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_NO2.In, tank4.MeasurePort) annotation (Line(
        points={{-74,102},{-74,90.5},{-74.5,90.5}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(tank5.T, tank2.T) annotation (Line(
        points={{-36,90},{-36,96},{-64,96},{-64,90}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank1.In, mixer.Out) annotation (Line(
        points={{-114,86},{-122,86},{-122,113.7},{-126,113.7}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(tank1.T, tank2.T) annotation (Line(
        points={{-114,90},{-116,90},{-116,96},{-64,96},{-64,90}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank3.T, tank2.T) annotation (Line(
        points={{-8,90},{-8,96},{-64,96},{-64,90}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(blower3.u, Constant1.y) annotation (Line(
        points={{-16.1,27},{-16.1,6},{-95,6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank5.AirIn, blower3.AirOut) annotation (Line(
        points={{-26,76.2},{-26,58},{-26,40},{-27,40}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank3.AirIn, blower2.AirOut) annotation (Line(
        points={{2,76.2},{2,40},{1,40}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(blower1.u, Constant1.y) annotation (Line(
        points={{-44.1,27},{-44,6},{-95,6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank2.AirIn, blower1.AirOut) annotation (Line(
        points={{-54,76.2},{-54,40},{-55,40}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(divider2_1.Out1, jenaSecClarModTakacs.Feed) annotation (Line(
        points={{55.9,83},{60.95,83},{60.95,83.4},{64,83.4}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(divider2_1.Out2, RecyclePump.In) annotation (Line(
        points={{56,78.2},{60,78.2},{60,78},{62,78},{62,73.3},{-86,73.3}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(divider2_1.In, tank3.Out) annotation (Line(
        points={{35.9,80.3},{23.95,80.3},{23.95,86},{12,86}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_NO2.Sno, FixedDelay1.u) annotation (Line(
        points={{-64.2,112},{-58,112},{-58,110},{-53.4,110}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(FixedDelay1.y, RecycleController1.in1) annotation (Line(
        points={{-37.3,110},{-21.7,110}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(RecycleController1.out, RecyclePump.u) annotation (Line(
        points={{-6.3,110},{14,110},{14,67.5},{-87.2,67.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(sensor_COD2.In, mixer.In1) annotation (Line(
        points={{-82,176},{-82,176},{-82,172},{-82,172},{-82,162},{-104,162},{
            -104,150},{-152,150},{-152,117.9},{-146,117.9}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_NH2.In, mixer.In1) annotation (Line(
        points={{-60,176},{-60,176},{-60,174},{-60,174},{-60,162},{-104,162},{
            -104,150},{-152,150},{-152,117.9},{-146,117.9}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_NO3.In, mixer.In1) annotation (Line(
        points={{-38,176},{-38,162},{-104,162},{-104,150},{-152,150},{-152,
            117.9},{-146,117.9}},
        color={0,0,255},
        smooth=Smooth.None));
    annotation (
      Diagram(coordinateSystem(extent={{-180,-100},{140,220}},
            preserveAspectRatio=false), graphics={
                                 Line(points={{-125,170},{-120,170}})}),
      Icon(coordinateSystem(extent={{-180,-100},{140,220}})),
      Commands(file="Resources/ASM3/BSM1.mos"));
  end BSM1;
end Examples;
