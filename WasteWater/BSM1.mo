  ...
  package Examples
    ...
    class BenchPlant "COST Benchmark WWTP Configuration"
      ...
      WasteWater.BSM1.sensor_ME ME
        annotation (Placement(transformation(extent={{93,67},{113,87}})));
      WasteWater.BSM1.sensor_AE AE
        annotation (Placement(transformation(extent={{93,88},{113,108}})));
      ...
      WasteWater.BSM1.pump pumpR(Q_max=20000)
      ...
      WasteWater.BSM1.nitri_tank5 tank5
        annotation (Placement(transformation(extent={{56,23},{76,43}})));
      ...
      WasteWater.BSM1.Settler9 settler9_1
        annotation (Placement(transformation(extent={{154,26},{174,46}})));
    equation
      ...
      connect(ME.ME, OCI.ME) annotation (Line(
          points={{112.8,77},{311,77},{311,12},{317,12}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(AE.AE, OCI.AE) annotation (Line(
          points={{113.2,98},{320,98},{320,17.4},{317,17.4}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(tank5.Out, divider.In) annotation (Line(
          points={{76,33},{93,33},{93,33.3},{112,33.3}},
          color={0,0,0},
          smooth=Smooth.None));
      connect(ME.Kla5, tank5.Kla) annotation (Line(
          points={{93,68},{93,36},{66,36}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(AE.Kla5, tank5.Kla) annotation (Line(
          points={{93,94},{93,36},{66,36}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(SP.u, Qr.In) annotation (Line(points={{254.8,-31.8},{254,-31.8},{
              254,-13},{142,-13}}, color={0,0,255}));
      connect(settler9_1.Feed, divider.Out1) annotation (Line(points={{155,37},
              {144,37},{144,35.6},{132,35.6}}, color={0,0,255}));
      connect(settler9_1.Effluent, EQ.In) annotation (Line(points={{173,37},{
              179,37},{179,40},{186,40}}, color={0,0,0}));
      connect(settler9_1.Waste, pump.In) annotation (Line(points={{167,27},{174,
              27},{174,2},{179,2},{179,-34.7},{194,-34.7}}, color={0,0,0}));
      connect(settler9_1.Recycle, Qr.In) annotation (Line(points={{159,27},{152,
              27},{152,3},{150,3},{150,-13},{142,-13}}));
      connect(pumpA.In, Qa.Out) annotation (Line(points={{-84,15.3},{13,15.3},{
              13,16},{108,16}}, color={0,0,255}));
      connect(pumpR.In, Qr.Out) annotation (Line(points={{2,-13.7},{63,-13.7},{
              63,-13},{122,-13}}, color={0,0,255}));
      annotation (
        Diagram(coordinateSystem(
            preserveAspectRatio=false,
...
"));
    ...
    class BenchPlant_A9 "COST Benchmark WWTP Configuration"
      import WasteWater;
...
"),     experiment(
    ...
    class BenchPlant_A10 "COST Benchmark WWTP Configuration"
      import WasteWater;
      ...
      Modelica.Blocks.Sources.CombiTimeTable Input(
        ...
        fileName=ModelicaServices.ExternalReferences.loadResource(
            "modelica://WasteWater/Resources/ASM1/Inf_dry.txt"))
        annotation (Placement(transformation(extent={{-266,76},{-246,96}})));
      WasteWater.BSM1.Settler_extender settler_extender
        annotation (Placement(transformation(extent={{154,26},{174,46}})));
    equation
      connect(tank3.Out, tank4.In) annotation (Line(points={{-15,33},{-15,33},{
              11,33}}));
      ...
      connect(SP.u, Qr.In) annotation (Line(points={{254.8,-31.8},{254,-31.8},{
              254,-13},{142,-13}}, color={0,0,255}));
      connect(settler_extender.Feed, divider.Out1) annotation (Line(points={{
              155,37},{144,37},{144,35.6},{132,35.6}}, color={0,0,255}));
      connect(settler_extender.Effluent, EQ.In) annotation (Line(points={{173,
              37},{179,37},{179,40},{186,40}}, color={0,0,0}));
      connect(settler_extender.Waste, pump.In) annotation (Line(points={{167,27},
              {174,27},{174,2},{179,2},{179,-34.7},{194,-34.7}}, color={0,0,0}));
      connect(settler_extender.Recycle, Qr.In) annotation (Line(points={{159,27},
              {152,27},{152,3},{150,3},{150,-13},{142,-13}}));
      connect(pumpA.In, Qa.Out) annotation (Line(points={{-84,15.3},{13,15.3},{
              13,16},{108,16}}, color={0,0,255}));
      connect(pumpR.In, Qr.Out) annotation (Line(points={{2,-13.7},{63,-13.7},{
              63,-13},{122,-13}}, color={0,0,255}));
...
"));
  ...
  model Settler9 "This is how we do exercise 9"
  ...
  equation
    ...
    Feed.Q + Recycle.Q + Waste.Q + Effluent.Q = 0;
    ...
    annotation (Icon(graphics={Rectangle(extent={{-80,46},{80,-80}}, lineColor={28,
                108,200}), Bitmap(extent={{-140,80},{140,-80}}, fileName="")}));
  end Settler9;

  model Settler_extender "This is how we do exercise 10"
    extends Settler9;
